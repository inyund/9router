export default {
  ...
  models: [
    // FP8/AWQ are quantisations, not efforts: they name how the weights are served,
    // not how much compute the model spends, so they carry the family unshifted.
    { id: "@cf/meta/llama-3.2-1b-instruct", name: "Llama 3.2 1B Instruct", family: "llama-3.2-1b" },
    { id: "@cf/meta/llama-3.2-3b-instruct", name: "Llama 3.2 3B Instruct", family: "llama-3.2-3b" },
    { id: "@cf/meta/llama-3.1-8b-instruct-fp8-fast", name: "Llama 3.1 8B Instruct FP8 Fast", family: "llama-3.1-8b" },
    { id: "@cf/meta/llama-3.1-8b-instruct-awq", name: "Llama 3.1 8B Instruct AWQ", family: "llama-3.1-8b" },
    { id: "@cf/mistralai/mistral-small-3.1-24b-instruct", name: "Mistral Small 3.1 24B Instruct", family: "mistral-small-3.1-24b" },
    { id: "@cf/meta/llama-3.1-70b-instruct-fp8-fast", name: "Llama 3.1 70B Instruct FP8 Fast", family: "llama-3.1-70b" },
    { id: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", name: "Llama 3.3 70B Instruct FP8 Fast", family: "llama-3.3-70b" },
